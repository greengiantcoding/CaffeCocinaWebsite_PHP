		...
		<div class='col-xs-5 col-xs-offset-1 navbarLink navbarBack collapse navbar-collapse' id='theList'>
			<ul class='centerItem listItems'>
				...
				<li class='dropdown navLinks navLinkBack navLinkOn'>
					<a href="#" class='dropdown-toggle listLinkColorOn' data-toggle='dropdown' role='button' aria-expanded='false'>Menu<span class="caret"></span></a>
					<ul class='dropdown-menu' role='list'>
						<li class='navLinksDropdown'><a class='navLinksDropdownColor' href='/menu'>Caffe Menu</a></li>
						<li class='navLinksDropdown'><a class='navLinksDropdownColor' href='/catering'><span class='currentDropdown'>Catering <i class="fa fa-coffee"></i></span></a></li>
					</ul>
				</li>
...
<!-- MAIN BODY OF LANDING PAGE -->
  <div class='col-xs-12' id='constructionNotice'>
    <h1 class='centerText'> Catering *Under Construction* Stay Tuned</h1>
  </div>
